...
// Ambil produk terlaris (top 5)
$topProducts = $orderManager->getTopSellingProducts($startDate, $endDate, 5);
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <div>
                    ...
                    <p class="text-muted">Monitor sales performance and manage orders.</p>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    <form method="get" class="row g-3 align-items-end">
                        <div class="col-md-4">
                            <label for="start_date" class="form-label fw-medium text-muted small text-uppercase">Start Date</label>
                            <input type="date" id="start_date" name="start_date" class="form-control"
                                   value="<?php echo htmlspecialchars($startDate ?? ''); ?>">
                        </div>
                        <div class="col-md-4">
                            <label for="end_date" class="form-label fw-medium text-muted small text-uppercase">End Date</label>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    <div class="stat-card h-100 p-4 bg-white rounded shadow-sm border-0">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h6 class="text-muted mb-1 text-uppercase small fw-bold">Total Orders</h6>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    orderDetailsModal.addEventListener('show.bs.modal', function (event) {
        ...
        fetch(`ajax_get_order_details.php?order_id=${orderId}`)
            ...
            .catch(error => {
                modalBody.innerHTML = '<div class="alert alert-danger m-3">Failed to load order details.</div>';
